...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-CCJScp-5.mjs");
...
const manifest = {
  "0be4c5e2fb38d0d04ca779c54fc9bcd56845ba36585f434eb043d3a83c0abaed": {
    functionName: "addPatient_createServerFn_handler",
    importer: () => import("./database.functions-Dkp20N8a.mjs")
  },
  "2261613e621672cf612b2a746c83b30ebbce91c4084579d7b45ef72a11d63e17": {
    functionName: "addFood_createServerFn_handler",
    importer: () => import("./database.functions-Dkp20N8a.mjs")
  },
  "375d997bd1a4828cf68e97f84fc29c8bafed29b37f9a18ed2f0c2cf37cb292dc": {
    functionName: "updatePatient_createServerFn_handler",
    importer: () => import("./database.functions-Dkp20N8a.mjs")
  },
  "42ac39f2959eaa3d8152cb30609721ba34cd7aeab93061b7a262f8ff207308a9": {
    functionName: "updateFood_createServerFn_handler",
    importer: () => import("./database.functions-Dkp20N8a.mjs")
  },
  "4a054d10d5a5732fa92e0edc20fecc809429be5855f482bc12f27624383226ee": {
    functionName: "deleteFood_createServerFn_handler",
    importer: () => import("./database.functions-Dkp20N8a.mjs")
  },
  "55e750c373d5c050d313bf4afbab306c84a10fe3b2f0633ccb6ed2a65c7b1e97": {
    functionName: "deleteProgressEntry_createServerFn_handler",
    importer: () => import("./database.functions-Dkp20N8a.mjs")
  },
  "66af482de39a6f8183715cde3c2da0f2b1cca898fcb9fa1c8b0d9a3a3acf1fb3": {
    functionName: "getPatients_createServerFn_handler",
    importer: () => import("./database.functions-Dkp20N8a.mjs")
  },
  "755e2d6cacd1a25565bc1233237561ddb031c0a989955e02a221e0b0f4c75112": {
    functionName: "getPlanForPatient_createServerFn_handler",
    importer: () => import("./database.functions-Dkp20N8a.mjs")
  },
  "7aa5e07fa5742934acc25a1ac72ea66b4003fc6052a69a3bfec34905ff3c0bbf": {
    functionName: "getFoods_createServerFn_handler",
    importer: () => import("./database.functions-Dkp20N8a.mjs")
  },
  "8542ceca8f92e07044762468e1d9b43091d9c337b3383d8950bc33eb18763fd7": {
    functionName: "getProgressForPatient_createServerFn_handler",
    importer: () => import("./database.functions-Dkp20N8a.mjs")
  },
  "9148d632394f7e1af801c872f3a8498973e241b0d2d8ef455868fa086f9fe6fd": {
    functionName: "verifyPassword_createServerFn_handler",
    importer: () => import("./auth.functions-BMXGOyMc.mjs")
  },
  "c260d2d6674852f91abad0d06aa0b32e0dbad59e8885851140a70962e4cb953b": {
    functionName: "deletePatient_createServerFn_handler",
    importer: () => import("./database.functions-Dkp20N8a.mjs")
  },
  "c418bd9896403311ccd7fe87bffcf795c15617fb4a0f5bb7c861e2270056a1ea": {
    functionName: "updateProgressEntry_createServerFn_handler",
    importer: () => import("./database.functions-Dkp20N8a.mjs")
  },
  "f452290df2ee5c30fd2396414c5b4b2d92ee3001f4514240cafe4b5cfefded4d": {
    functionName: "savePlan_createServerFn_handler",
    importer: () => import("./database.functions-Dkp20N8a.mjs")
  },
  "f753cc5a6a451f7ffc6c166fe8f25268accb08e2728e9a60a1fa43d2e9001fa9": {
    functionName: "addProgressEntry_createServerFn_handler",
    importer: () => import("./database.functions-Dkp20N8a.mjs")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-BL5U29WJ.mjs").then((n) => n.r),
    import("./start-CdiTQWmP.mjs"),
